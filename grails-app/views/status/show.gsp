	...
	<body>
		...
		<div id="show-status" class="content scaffold-show" role="main">
			...
			<ol class="property-list status">
				...
				<g:if test="${statusInstance?.ordering}">
				<li class="fieldcontain">
					<span id="ordering-label" class="property-label"><g:message code="status.ordering.label" default="Ordering" /></span>
					
						<span class="property-value" aria-labelledby="ordering-label"><g:fieldValue bean="${statusInstance}" field="ordering"/></span>
